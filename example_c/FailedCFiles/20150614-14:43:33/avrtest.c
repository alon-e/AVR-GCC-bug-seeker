...
static int32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_4[3][7] = {{0xE77AL,(-1L),(-1L),0xE77AL,7L,0xE77AL,(-1L)},{(-8L),(-8L),0xAEB9L,1L,0xAEB9L,(-8L),(-8L)},{0xB8FAL,(-1L),0L,(-1L),0xB8FAL,0xB8FAL,(-1L)}};
    int32_t *l_7 = &g_6[1];
    int32_t *l_8 = &g_6[1];
    int32_t l_9 = (-4L);
    int32_t *l_10 = &g_6[0];
    ...
    for (i = 0; i < 7; i++)
        l_14[i] = &l_9;
    (*g_5) &= ((uint16_t)l_4[2][4] * (uint16_t)7UL);
    l_15--;
    return (*l_8);
}
