...
/* --- GLOBAL VARIABLES --- */
static int32_t g_6[2][3] = {{(-5L),8L,(-5L)},{(-5L),8L,(-5L)}};
...
{ /* block id: 0 */
    int8_t l_4 = 0xA1L;
    int32_t *l_5[5][4] = {{(void*)0,&g_6[1][0],(void*)0,(void*)0},{&g_6[1][0],&g_6[1][0],(void*)0,&g_6[1][0]},{&g_6[1][0],(void*)0,(void*)0,&g_6[1][0]},{(void*)0,&g_6[1][0],(void*)0,(void*)0},{&g_6[1][0],&g_6[1][0],(void*)0,&g_6[1][0]}};
    uint32_t l_11 = 0x0FDB6968L;
    int i, j;
    g_6[1][1] = ((int16_t)0xCE12L >> (int16_t)l_4);
    g_6[1][2] = ((int8_t)((((uint16_t)g_6[0][0] * (uint16_t)l_11) , 0xFA31L) ^ g_6[0][1]) * (int8_t)g_6[1][0]);
    return g_6[1][0];
}
