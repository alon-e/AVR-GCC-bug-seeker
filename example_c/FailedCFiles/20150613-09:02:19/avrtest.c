...
/* --- GLOBAL VARIABLES --- */
static int32_t g_8 = 0x5E3EDFA8L;
static volatile uint32_t g_10 = 0xDADE0980L;/* VOLATILE GLOBAL g_10 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_7 = 0xA86BA47CL;
    int32_t *l_9[5];
    int i;
    for (i = 0; i < 5; i++)
        l_9[i] = &g_8;
    g_8 ^= ((uint32_t)((uint16_t)((!0xF4L) , 65530UL) << (uint16_t)l_7) + (uint32_t)8UL);
    --g_10;
    return g_8;
}
