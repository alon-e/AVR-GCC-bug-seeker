...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_4[2] = {0x2B165808L,0x2B165808L};
static int32_t g_5[7] = {0x62A2B3B7L,0x62A2B3B7L,0x62A2B3B7L,0x62A2B3B7L,0x62A2B3B7L,0x62A2B3B7L,0x62A2B3B7L};
static int32_t g_8 = 0x10FECAFEL;
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_5 g_8 g_13 g_14 g_17
...
{ /* block id: 0 */
    ...
    int i, j;
    g_8 ^= ((int8_t)(((g_4[0] && g_4[0]) <= g_5[3]) , g_4[0]) << (int8_t)l_6);
    g_17 = func_9(&g_8, l_7[0][0], &l_7[1][0]);
    return g_4[0];
}
