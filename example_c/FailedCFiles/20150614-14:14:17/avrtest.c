...
static uint16_t g_3 = 0x0A35L;
static int32_t g_15 = 6L;
static uint16_t g_18[3] = {0xEDACL,0xEDACL,0xEDACL};
...
/* 
 * reads : g_2 g_3 g_15
 * writes: g_3 g_15 g_18
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0xA4F402E3L;
    l_4 ^= (g_2 | g_3);
    for (g_3 = 17; (g_3 >= 15); g_3 -= 3)
    { /* block id: 4 */
        uint8_t l_13 = 255UL;
        int32_t *l_14 = &g_15;
        (*l_14) = ((uint16_t)((int16_t)((uint8_t)(g_2 | g_3) << (uint8_t)g_3) - (int16_t)l_13) * (uint16_t)g_3);
        for (l_13 = 23; (l_13 <= 2); l_13--)
        { /* block id: 8 */
            g_18[2] = ((*l_14) |= 0xC7BE0218L);
        }
    }
    return l_4;
}
