...
static int16_t g_9 = 0x6EFFL;
static int32_t *g_14 = &g_7;
...
{ /* block id: 0 */
    int16_t *l_8 = &g_9;
    int32_t *l_10 = (void*)0;
    g_14 = func_2(((int16_t)((*l_8) = ((g_7 >= 4294967292UL) | 0UL)) << (int16_t)g_7), l_10);
    return g_7;
}
...
static int32_t * func_2(int8_t  p_3, int32_t * p_4)
{ /* block id: 2 */
    uint32_t l_13 = 0xF6285890L;
    g_7 ^= ((uint16_t)g_9 - (uint16_t)l_13);
    return &g_7;
}
